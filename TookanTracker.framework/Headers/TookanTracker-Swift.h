...
+ (LocationTrackerFile * _Nonnull)sharedInstanceWithApiKey:(NSString * _Nonnull)apiKey SWIFT_WARN_UNUSED_RESULT;
+ (CLLocationManager * _Nonnull)sharedLocationManager SWIFT_WARN_UNUSED_RESULT;
- (CLLocation * _Nonnull)getCurrentLocation SWIFT_WARN_UNUSED_RESULT;
...
- (uint16_t)publishWithMessage:(CocoaMQTTMessage * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
- (uint16_t)unsubscribeWithTopic:(NSString * _Nonnull)topic SWIFT_WARN_UNUSED_RESULT;
- (void)ping;
- (void)disconnect;
...
+ (NSData * _Nullable)requestSynchronousData:(NSURLRequest * _Nonnull)request SWIFT_WARN_UNUSED_RESULT;
/// Return data synchronous from specified endpoint
+ (NSData * _Nullable)requestSynchronousDataWithURLString:(NSString * _Nonnull)requestString SWIFT_WARN_UNUSED_RESULT;
/// Return JSON synchronous from URL request
+ (id _Nullable)requestSynchronousJSON:(NSURLRequest * _Nonnull)request SWIFT_WARN_UNUSED_RESULT;
/// Return JSON synchronous from specified endpoint
+ (id _Nullable)requestSynchronousJSONWithURLString:(NSString * _Nonnull)requestString SWIFT_WARN_UNUSED_RESULT;
@end
